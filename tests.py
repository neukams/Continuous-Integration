...
class TestMyDatetime(unittest.TestCase):
    ...
    def random_testing(self):
        ...
        self.assertEqual(my_mydatetime(180554127899), "07-13-7691")
        self.assertEqual(my_mydatetime(30578684726), "12-31-2938")
        self.assertEqual(my_mydatetime(104203010137), "01-23-5272")
        self.assertEqual(my_mydatetime(169420530963), "09-21-7338")
        self.assertEqual(my_mydatetime(105140905211), "10-13-5301")
        self.assertEqual(my_mydatetime(175800114903), "11-19-7540")
        self.assertEqual(my_mydatetime(162283651159), "07-25-7112")
        self.assertEqual(my_mydatetime(154249369071), "12-19-6857")
        self.assertEqual(my_mydatetime(163297868897), "09-14-7114")
        self.assertEqual(my_mydatetime(23588344039), "06-27-2717")
        self.assertEqual(my_mydatetime(130622646521), "04-08-6109")
        self.assertEqual(my_mydatetime(12974675870), "02-24-2381")
        self.assertEqual(my_mydatetime(83076822877), "09-08-4602")
        self.assertEqual(my_mydatetime(151727270369), "01-17-6778")
        self.assertEqual(my_mydatetime(142695209990), "10-30-6491")
        self.assertEqual(my_mydatetime(48667988133), "03-24-3512")
        self.assertEqual(my_mydatetime(47729571464), "06-28-3482")
        self.assertEqual(my_mydatetime(76749863467), "02-08-4402")
        self.assertEqual(my_mydatetime(36924182774), "01-31-3140")
        self.assertEqual(my_mydatetime(162929327398), "01-10-7133")
